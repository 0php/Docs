        ...
        <div className="flex flex-col lg:flex-row gap-12 max-w-[1224px] mx-auto">
          <div className="lg:w-[264px]">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold font-space-grotesk bg-[linear-gradient(94deg,#0554CB_16.78%,#AD90FF_53.33%)] bg-clip-text text-transparent">Install ZeroPHP</h3>
            ...
            <div className="glass-card rounded-[20px] p-8 lg:max-w-[832px]">
              ...
              <div className="space-y-1 font-space-grotesk text-base">
                <div>
                  ...
                  <span className="text-white font-bold">curl -L -o main.zip https://github.com/0php/Zero/archive/refs/heads/main.zip</span>
      ...
      <footer className="px-6 lg:px-[108px] py-8">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 max-w-[1224px] mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-2 lg:gap-2 text-white font-space-grotesk text-lg font-bold">
            ...
            <a href="https://syntac.co" className="hover:text-blue transition-colors">Syntac</a> &amp; 
            <a href="https://bytelogic.me" className="hover:text-blue transition-colors">BeteLogic</a>
          </div>
          
          <div className="flex flex-wrap justify-center gap-6 text-sm text-white font-space-grotesk">
            <Link href="#" className="hover:text-[#5972E5] transition-colors">License</Link>
            <Link href="#" className="hover:text-[#5972E5] transition-colors">Term of Services</Link>
            <Link href="#" className="hover:text-[#5972E5] transition-colors">Contact Us</Link>
          </div>
        </div>
      </footer>
    </div>
