  ...
  return (
    <main className='bg-[#0E0E0E]'>
      <div className='md:absolute fixed inset-0 w-screen h-full md:overflow-visible overflow-hidden'>
        <div className='absolute w-[22vw] h-[36vh] rounded-full bg-[#9ec5ff] opacity-50 blur-[10vw] rotate-[105deg] top-[15vh] left-[15vw] pulse-1' />
        ...
        <div className='absolute w-[22vw] h-[36vh] rounded-full bg-[#9ec5ff] opacity-50 blur-[10vw] rotate-[105deg] top-[110vh] right-[12vw] pulse-3' />
        <div className='absolute w-[22vw] h-[36vh] rounded-full bg-[#9ec5ff] opacity-50 blur-[10vw] rotate-[105deg] top-[180vh] right-[12vw] pulse-4' />
