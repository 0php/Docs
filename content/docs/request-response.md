...
These are thin wrappers around `Response::*` and `Request::*` defined in [`core/libraries/Support/Helper.php`](../core/libraries/Support/Helper.php). See [helpers.md](/docs/helpers) for the full list.
